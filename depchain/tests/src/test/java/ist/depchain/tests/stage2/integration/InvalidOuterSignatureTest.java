...
class InvalidOuterSignatureTest {
        ...
        void setup() {
                ...
                long requestBase = ServerApp.getCoordinator("s0").getServerContext().getBlockChain().getHeight()
                                * 1000L;
                clientContext.setRequestId((int) requestBase);
                clientContext.setNonce(
                                ServerApp.getCoordinator("s0").getServerContext().getWorldState().getNonce(sender));
        ...
        /**
         * Outer request envelope signed with a random key (not client1's registered
         * key).
        ...
        /**
         * Attacker uses their own key to sign the request but claims clientId =
         * "client1".
